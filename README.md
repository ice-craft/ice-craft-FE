...
|                                                                                     박서영                                                                                     |                                                                                                          김명환                                                                                                           |                                                                    이준구                                                                     |                  안주원                  |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------: |
| **Features**<br><br>전체페이지 퍼블리싱<br>마피아게임 Info 페이지 제작<br>WebRTC livekit 연결 작업<br>마피아 게임 페이지 레이아웃 작업<br>마피아 게임 페이지 socket.io 연결<br>socket.io통신 기반 UI 로직 입히기<br>모달창 작업<br> | <br>**Features**<br><br>supabase 전체 DB설계 및 구현<br>로그인 페이지 구현<br>회원가입 페이지 구현<br>server에서 받아오는 클라이언트 측 socket.io 통신 작업 구현<br>마피아 게임 알고리즘 자바스크립트 기반 전체 구현<br>마피아 게임 express를 이용한 server 작업<br>마피아 게임 socket.io를 이용한 web socket 통신 구현<br>SWC 배포 작업<br> | **Features**<br><br>livekit 연결 후 socket.io와 연동, 리팩토링<br>마피아 게임 페이지 socket.io와 UI 로직 연결<br>페이지 별 전역상태 관리, 커스텀 훅 구현<br> | **Features**<br><br>인트로페이지 제작<br>메인페이지 제작<br>랭킹페이지 제작<br> |
